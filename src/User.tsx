import { IconBrandGithub, IconBrandLeetcode, IconBrandLinkedin, IconChefHat } from "@tabler/icons-react";
const Info = {
    name: "Harshal Nimse",
    stack: ["Software Engineer", "Java Full Stack Developer", "Android Developer", "", "Open Source Contributor"],
...
const SkillInfo = [
    {
        title: "Frontend",
        skills: ["HTML", "CSS", "JavaScript", "React JS", "Mantine UI", "Tailwind CSS", "Material UI", "Bootstrap"]
    },
    {
        title: "Backend",
    ...
    {
        title: "Languages",
        skills: ["Java", "C", "Python", "JavaScript", "C++", "TypeScript"]
    },
    {
        title: "Tools",
        skills: ["Git", "Github", "VS Code", "Postman", "Android Studio", "Spring Tool Suite"]
    }
]
const socialLinks = [
    { link: "https://github.com/snctnms1431", icon: IconBrandGithub },
    { link: "https://www.linkedin.com/in/harshal-nimse-73b496326/", icon: IconBrandLinkedin },
    { link: "https://www.codechef.com/users/snct_3114", icon: IconChefHat }, 
    { link: "https://leetcode.com/u/SanchiT3114/", icon: IconBrandLeetcode }
];
